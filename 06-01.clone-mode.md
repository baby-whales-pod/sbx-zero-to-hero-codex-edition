...
![clone mode](.assets/06-01-sbx-clone-mode.drawio.svg)

> 🖉 Editable source: [`.assets/06-01-sbx-clone-mode.drawio.svg`](./.assets/06-01-sbx-clone-mode.drawio.svg) — open at <https://app.diagrams.net>.
