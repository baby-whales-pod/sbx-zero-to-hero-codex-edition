...
Instruct the Codex agent with the following prompts (one at a time):
- "show me the content of the repository"
- "create a README.md file with a story about docker compose"
- "go the parent directory (`cd ..`) then create a `hello.txt` file with a greeting message"
